...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       ...
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/RPOTCMPerformOperationToCompletionManager"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Richard Reitzfeld" => "richie.reitzfeld@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/RPOTCMPerformOperationToCompletionManager.git", :tag => s.version.to_s }
  ...
  s.resource_bundles = {
    'RPOTCMPerformOperationToCompletionManager' => ['Pod/Assets/*.png']
  }
