...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-RPOTCMPerformOperationToCompletionManager_Example/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework 'FXReachability.framework'
  install_framework 'RPOTCMPerformOperationToCompletionManager.framework'
fi
